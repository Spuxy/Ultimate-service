...
func run(log *zap.SugaredLogger) error {
	...
	// construct a srver to service the requests agaisnt the mux
	api := http.Server{
	...
	// make a channel to listen for errors coming from the listener, use a uffered channel so the goroutine can exit if we dont collect this err
